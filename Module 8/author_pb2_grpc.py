...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in author_pb2_grpc.py depends on'
...
class AuthorServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetAuthor = channel.unary_unary(
                ...
                response_deserializer=author__pb2.AuthorReply.FromString,
...
def add_AuthorServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetAuthor': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=author__pb2.AuthorReply.SerializeToString,
            ),
    }
...
class AuthorService(object):
    ...
    def GetAuthor(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            author__pb2.AuthorReply.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
